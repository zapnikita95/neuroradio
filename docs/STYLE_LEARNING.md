...
| Условие | Значение |
|---------|----------|
| Лайки с `good_persona` | **≥ 1** на уникальный script (раньше ошибочно требали 10 на один текст) |
| Разные треки | **≥ 1** |
...
| `STYLE_PROMOTE_MIN_LIKES` | 1 | Лайков good_persona на script |
| `STYLE_PROMOTE_MIN_TRACKS` | 1 | Разных треков |
