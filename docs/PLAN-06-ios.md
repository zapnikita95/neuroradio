...
| `TellStoryWidget.swift` | Виджет → deep link `musicstory://tell-story` |
...
4. Redirect URI: `musicstory://spotify-callback`
...
```json
{
  ...
  "cert_sha256": "sha256(ios:com.musicstory.app:TEAM_ID)",
  "platform": "ios",
  "team_id": "ABCDE12345"
}
```
