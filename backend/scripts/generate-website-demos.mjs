...
const THRILLER_STORY_MINUTE =
  ...
  'Michael Jackson записал Thriller в эпоху, когда музыкальные клипы только начинали менять правила игры. Это был не просто трек — целый кинематографический опыт, растянутый на четырнадцать минут. В те годы MTV крутил в основном рок, но клип Thriller взломал систему: его ставили в эфир целиком, прерывая регулярное вещание — случай беспрецедентный. Джексон понимал, что будущее за визуальными историями, и вложил в съёмки полмиллиона долларов из своего кармана. Бюджет казался безумием, но окупился сполна: продажи альбома подскочили в семь раз после премьеры видео. Клип снял John Landis, режиссёр «Американского оборотня в Лондоне» — столкновение двух вселенных. Сцена с зомби-танцами изначально не входила в сценарий: хореографу Майклу Питерсу пришлось убеждать Джона Ландиса, что это не испортит хоррор-эстетику. В итоге танец стал визитной карточкой ролика.';
...
const BACKSTAGE_STORY_SHORT =

  'Только между нами. ' +

  FACT_BUDGET +

  ' Vincent Price уложил закадровый монолог в один день — без его голоса клип был бы совсем другим. Об этом редко говорят вслух.';
...
const BACKSTAGE_STORY_EXTRA =

  ' Гримёры тратили по четыре часа на каждого «зомби» — в коридорах пахло латексом и клеем. Jackson требовал переснимать финальный кадр, пока шаг не совпадёт с битом. Лейбл молчал о цифрах, пока продажи не подскочили в семь раз — тогда даже скептики притворились, что изначально верили в безумие. Позже ролик включили в National Film Registry — единственный music video в списке культурного наследия США.';

const BACKSTAGE_STORY_FULL = BACKSTAGE_STORY_MINUTE + BACKSTAGE_STORY_EXTRA;

/** Современник эпохи — от первого лица, ностальгия (не энциклопедический THRILLER_STORY_MINUTE). */
const CONTEMPORARY_STORY_MINUTE =
  'Michael Jackson вложил пятьсот тысяч долларов из своего кармана в создание музыкального видео на трек Thriller. Мы помним, тогда MTV в основном крутила рок, но этот четырнадцатиминутный ролик показывали целиком, прерывая обычные программы. Я помню то невероятное чувство, когда после премьеры видео продажи альбома выросли в семь раз. Режиссёр John Landis пришёл из большого кино, а хореографу Майклу Питерсу даже пришлось убеждать Джона Ландиса оставить ту самую сцену с танцем зомби. Это было не просто видео, а настоящее событие, которое меняло правила игры на телевидении. Позже люди начали массово скупать кассеты VHS в магазинах, чтобы пересматривать этот шедевр дома снова и снова. Весь мир замер, когда этот ролик появился в эфире, и музыка стала частью визуальной истории. Это был момент, когда поп-музыка окончательно объединилась с кинематографом.';
...
const PERSONAS = [
...

  {
    ...
    short: BACKSTAGE_STORY_SHORT,

    minute: BACKSTAGE_STORY_MINUTE,

    full: BACKSTAGE_STORY_FULL,
...
const DISPLAY_NAME_FIXES = [
  ...
  [/\bхореографу\s+майкл\s+питерс\b/gi, 'хореографу Майклу Питерсу'],
  [/\bубеждать\s+его\b/gi, 'убеждать Джона Ландиса'],
  [/\bубеждать\s+ландиса\b/gi, 'убеждать Джона Ландиса'],
