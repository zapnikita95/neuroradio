...
### Тестовая учётка для проверяющих ЮKassa

| Поле | Значение |
|------|----------|
| Email | `googletester@test.ru` |
| Код входа (приложение и сайт `#account`) | `000000` |
| Тариф после входа | Premium на 1 год, **10 историй/день**, SpeechKit + DeepSeek |
| Карта | Не привязана — можно пройти оплату и отвязку с нуля |

Письмо не отправляется; «Отправить код» необязателен — можно сразу ввести `000000`.
