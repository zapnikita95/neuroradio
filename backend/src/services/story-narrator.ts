...
- Финал: мысль «сильный факт для эфира» — да, но каждый раз другими словами; не повторяй штамп «в эфир не выкинешь — слушатели цепляются».`,
  },
  contemporary: {
    id: 'contemporary',
...
- ЗАПРЕЩЕНО выдумывать: «летний бриз», студию, гитару, «между турами», «в перерывах» — только если это ЕСТЬ в семени.
- Первое предложение = якорь из семени (чарт, стримы, релиз, платформа), не поэтическая картинка.`,
  },
};
