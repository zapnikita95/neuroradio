...
- Имена артистов, названия треков, альбомов, лейблов — ТОЧНО как в оригинале (латиницей/французски). НИКОГДА не переводи название трека на русский.
- Пример: трек "Laisse tomber les filles" — так и оставь, не «Оставь девушек».
