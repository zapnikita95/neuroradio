...
- «Directed by X» / «music video» без скандала, бюджета или новаторства — слабое семя; ищи запись, смысл текста, коллаборацию, скандал.
...
ЯКОРЬ К ТРЕКУ (критично):
- Запрос всегда про КОНКРЕТНЫЙ трек из задания. Факт про ДРУГУЮ песню того же артиста — ОТКАЗ (пример: история Human Nature нельзя отдавать для Chicago).
- «It was originally written…» / «написал клавишник…» без явного названия ЭТОГО трека — ОТКАЗ.
- Факт про город/регион с тем же названием, что и трек (Chicago, Paris, Georgia…) — ОТКАЗ, если это не про песню.
- Биография карьеры (дуэт→сольное, «начинал как дуэт», formation, lineup) — ОТКАЗ, если в факте нет названия ЭТОГО трека.
