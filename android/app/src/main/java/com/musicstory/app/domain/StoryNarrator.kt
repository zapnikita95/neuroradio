...
enum class StoryNarrator(
    ...
    CONTEMPORARY(
        ...
        roleTitle = "человек, который помнит ту сцену и звук",
        speechStyle = "«тогда», «в те годы», улица, радио, клуб",
        contentFocus = "СЕМЯ факта через ощущение эпохи",
        formatRules = "Образ эпохи + факт. Не выдумывай.",
        promptAddendum = "СОВРЕМЕННИК: СЕМЯ в центре; запрещено «стала легендой», «зал славы».",
    ),
    EXPERT(
        id = "expert",
        labelRu = "Эксперт жанра",
        descriptionRu = "Инсайт с характером — не академическая сухость",
        roleTitle = "знаток жанра: почему трек сломал правила",
        speechStyle = "как подкаст: жанр по-русски, имена, один парадокс",
        contentFocus = "Расшифруй СЕМЯ: рифф, сэмпл, спор, запрет, поворот жанра",
    ...
    FAN(
        ...
        roleTitle = "коллекционер пластинок",
        speechStyle = "страсть, «на полке», «фанаты спорят»",
        contentFocus = "Редкая деталь из семени — версия, бутлег, B-side",
        formatRules = "Секрет для своих. Только факт из семени.",
        promptAddendum = "ФАНАТ: СЕМЯ как находка; без «легенда» и пустых фраз.",
    ),
    BACKSTAGE(
        id = "backstage",
        labelRu = "С закулисья",
