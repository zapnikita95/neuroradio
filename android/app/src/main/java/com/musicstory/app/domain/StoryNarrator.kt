...
enum class StoryNarrator(
    ...
    CONTEMPORARY(
        ...
        speechStyle = "исповедь из памяти: «помню», «тогда», запах, звук, телесные ощущения",
        contentFocus = "личное воспоминание: где ты был, что почувствовал; эмоции важнее фактов",
        formatRules = "Только первое лицо и живая память. Не обращайся к слушателю как ведущий.",
    ),
    EXPERT(
        id = "expert",
