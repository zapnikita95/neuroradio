...
```
MusicStory-debug.apk
```

Установка на устройство:

```bash
adb install -r MusicStory-debug.apk
```
...
└── MusicStory-debug.apk  # Собранный APK для sideload
```
...
|------------|------------|
| `GROQ_API_KEY` | Генерация текста (Groq) |
| `PROXY_SECRET` | Защита API на Railway |
